...
const DetailsPage = () => {
  ...
  return (
    <div className="min-h-screen  bg-[#cfb284] text-white mt-16 p-3 flex flex-col md:flex-row gap-3">
      ...
      <div className="flex-1 bg-amber-00 rounded-lg p-6 space-y-4">
        ...
        <button className="bg-green-700 text-white cursor-pointer py-2 px-4 mt-4 rounded hover:bg-green-800">
          Add to Cart
        </button>
      </div>
    </div>
